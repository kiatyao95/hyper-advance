...
SERVICE_CAPABILITIES = [
    ...
    },
    {
        ...
        "icon": "fa-screwdriver",
        "title": "Repair",
        "description": "Diagnosis and repair of ELV equipments including, CCTV, Intercom, Public address and more by our trusted engineers.",
    },
    {
        "id": "troubleshoot",
        "icon": "fa-magnifying-glass-chart",
        "title": "Troubleshoot",
        "description": "Troubleshoot and diagnose issues of all types of ELV systems. Will resolve issue on the spot if possible and advise on how to maintain system properly.",
    },
    {
        "id": "programming",
        "icon": "fa-microchip",
